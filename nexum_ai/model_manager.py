...
class ModelManager:
    ...
    def _download_model(
        self, repo_id: str, filename: str, local_path: Path
    ) -> Optional[str]:
        """
        ...
        try:
            ...
            if final_path.exists():
                ...
                print(
                    "Model download completed but file not found at expected location"
                )
...
def test_model_manager():
    ...
    print(
        "  manager.ensure_model('phi-2.Q4_K_M.gguf', 'TheBloke/phi-2-GGUF', 'phi-2.Q4_K_M.gguf')"
    )
