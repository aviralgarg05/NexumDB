...
class TestQLearningAgent:
    ...
    def test_initialization(self):
        ...
        agent = QLearningAgent(learning_rate=0.2, discount_factor=0.8, epsilon=0.3)
    ...
    def test_get_state_key(self):
        ...
        state_key = agent._get_state_key(query_length=25, cache_hit=True, complexity=5)
    ...
    def test_get_action_exploration(self):
        ...
        action = agent.get_action(query_length=25, cache_hit=False, complexity=3)
    ...
    def test_get_action_exploitation(self):
        ...
        agent.q_table[state] = {"force_cache": 0.5, "bypass_cache": 1.5, "normal": 0.3}
    ...
    def test_get_action_new_state(self):
        ...
        action = agent.get_action(query_length=50, cache_hit=True, complexity=7)
